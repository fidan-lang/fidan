...
| Parser unit tests | ✅ | 22/22 passing in `fidan-parser/src/lib.rs` — var/action/object/control-flow/concurrency syntax + error recovery |
...
| Static-analysis passes (E0401, W1004) | ✅ | 5/5 tests in `fidan-interp/tests/integration.rs` — race detected, `Shared` safe, no-parallel clean, unawaited spawn detected, awaited spawn clean |
| Typeck unit tests | ⬜ | |

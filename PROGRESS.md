...
| REPL with history + multi-line | 🔨 | Colon commands done; full eval working; brace-tracking multi-line input exists but string-literal-aware counting + `:cancel` command needed |
